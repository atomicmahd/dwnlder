...
const S = {
  ...
  sidebar: { width: 220, background: '#13182a', borderRight: '1px solid #1e2a45', display: 'flex', flexDirection: 'column', padding: '24px 0' },
...
function Sidebar({ onLogout }) {
  const links = [
    ...
    { to: '/links', label: '🔗 Link History' },
    { to: '/logs', label: '📋 Logs' },
    { to: '/settings', label: '⚙️ Settings' },
  ]
  return (
    <div style={S.sidebar}>
      <div style={S.logo}>🤖 MediaBot</div>
      <nav style={S.nav}>
        {links.map(l => (
