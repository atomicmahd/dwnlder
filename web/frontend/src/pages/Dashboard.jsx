...
export default function Dashboard() {
  ...
  const cards = stats ? [
    ...
    { label: 'Today Downloads', value: stats.today_downloads },
    { label: 'Failed', value: stats.failed },
    { label: 'Total Volume', value: `${stats.total_volume_gb} GB` },
  ] : []
    ...
    <div style={S.page}>
      <div style={S.header}>
        ...
        <button style={S.pauseBtn(paused)} onClick={togglePause} disabled={loading}>
          {loading ? '...' : paused ? '▶ Resume Bot' : '⏸ Pause Bot'}
        </button>
      </div>
      ...
      {stats?.platforms && Object.keys(stats.platforms).length > 0 && (
        <div style={S.card}>
          <div style={S.platformsTitle}>Downloads by Platform</div>
